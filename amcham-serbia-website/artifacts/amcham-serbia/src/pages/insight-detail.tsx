    ...
    <div className="w-full bg-background min-h-screen pb-24">
      ...
      <section className="bg-secondary text-secondary-foreground pt-12 pb-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <Link href="/insights" className="inline-flex items-center gap-2 text-sm font-semibold hover:text-white mb-12 text-muted-foreground transition-colors">
            <ArrowLeft className="w-4 h-4" /> {t('insights.detail.back')}
          </Link>
          
          <div className="flex gap-3 mb-6">
            <span className="px-3 py-1 bg-white text-secondary text-xs font-bold uppercase rounded-sm tracking-wider">{type}</span>
            <span className="px-3 py-1 bg-transparent border border-white/20 text-white text-xs font-bold uppercase rounded-sm">{insight.year}</span>
          </div>
